          ...
          child: Container(
            ...
            child: Table(
              ...
              border: TableBorder.all(
                  color: const Color.fromARGB(255, 78, 75, 75), width: 0.5),
              children: [
                TableRow(
                  children: [
                    TableCell(
                    ...
                    children: [
                      ...
                      TableCell(
                        child: Container(
                          ...
                          padding: const EdgeInsets.all(10),
                          alignment: Alignment.center,
                          child: Text(rowData['directs_business'].toString(),
                              style: tabledata),
                        ),
                      ),
                      TableCell(
                        ...
                        padding: const EdgeInsets.all(10),
                        alignment: Alignment.center,
                        child: Text(rowData['team_business'].toString(),
                            style: tabledata),
                      )),
                      TableCell(
                          child: Container(
                        ...
                        padding: const EdgeInsets.all(10),
                        alignment: Alignment.center,
                        child: Text(rowData['status'].toString(),
                            style: tabledata),
                      )),
                    ],
                  ),
