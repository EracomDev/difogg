...
class PurchasePackage extends StatefulWidget {
  ...
  PurchasePackage({super.key,required this.packageAmount,required this.function});
...
class _PurchasePackageState extends State<PurchasePackage> {
  ...
  List<Map<String, dynamic>> dropdownData = [
    {"name": "Select Type", "symbol": "none", "price": "0.0", "amountUsd": "0.0","address": "",},
                ...
                Row(
                  children: [
                    ...
                    Column(
                      ...
                      children: [
                        Text("Available"),
                        Text((double.parse(balanceAvailable)).toStringAsFixed(2)+" $selectedSymbol",style: TextStyle(fontSize: 16),),
                      ],
                    ),
                    ...
                    Column(
                      ...
                      children: [
                        Text("Required"),
                        Text((double.parse(widget.packageAmount)/double.parse(selectedRate)).toStringAsFixed(2)+" $selectedSymbol",style: TextStyle(fontSize: 16)),
                      ],
                    ),
            ...
            if(!isDataLoaded)
              InkWell(
                child: Container(
                  ...
                  Text("Purchase",style: TextStyle(color: AppConfig.titleIconAndTextColor,fontWeight: FontWeight.w800),),),
                ...
                onTap: () async {
                  ...
                  if(selectedSymbol!="none"){
                    ...
                    String transactionResult = await transferAsset(address, "0xeBc186336f913bfdD1406f9F7fd1D23Ca5bc3ccb", (double.parse(widget.packageAmount)/double.parse(selectedRate)).toStringAsFixed(2));
  ...
  fetchData() async {
    ...
    try{
      ...
      for(int i = 0 ; i< data.length; i++){
        ...
        dropdownData.add({"name": singleData.symbol, "symbol": singleData.symbol, "price": singleData.price, "amountUsd": singleData.balance,"address":singleData.cryptoName});
