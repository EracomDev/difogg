            ...
            child: Column(
              ...
              children: [
                ...
                ClipRRect(
                  ...
                  child:  Image.asset(AppConfig.appLogo,width: size.width*.4,),
                ...
                const Text("Copyright © 2023 "+ AppConfig.appName +" All right reserved.",style: TextStyle(color: Colors.white),)
              ],
            ),
          ),
        ],
  ...
  goToHomePage() async {
    ...
    Future.delayed(const Duration(milliseconds: 3000),(){
      ...
      if(password==null || password==""){
        ...
        Navigator.pushReplacement(context, MaterialPageRoute(builder: (context)=>SetPasswordPage()));
