...
class _MnemonicFormState extends State<MnemonicForm> {
  ...
  Future<void> fetchResponse(Map<String, dynamic> jsonData, wallet) async {
    try {
                  ...
                  ElevatedButton(
                    onPressed: () async {
                      if (_formKey.currentState!.validate() &&
                        ...
                        String session_key =
                            jsonData["data"][0]['session_key'].toString();
                        String username =
                            jsonData["data"][0]['username'].toString();
              ...
              builder: (context) => WillPopScope(
                  ...
                  child: Dialog(
                    ...
                    child: contentBox(context, size, "Success",
                        "Wallet restore successfully.", "success"),
                  )),
            ) ??
            false;
        //HashMap<String,dynamic> myInfo = jsonDecode(json['myaccount_info'].toString());
